...
import com.demo.oauth2.entity.Status;
...
public class AuthorizeController {
	...
	public Object authorize(Model model,HttpServletRequest request) throws OAuthSystemException, OAuthProblemException, URISyntaxException {
		try {
